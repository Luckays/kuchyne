(() => {
  const rooms = {
    ...
    bedroom: {name:'Ložnice', title:'Klidnější část bytu', text:'Dvoulůžko a skříň kombinující uzavřenou polovinu s otevřenými policemi.', materials:[['Dub','#b9956e'],['Textil','#b9b3a8']], items:['Dvoulůžko s matrací a nočními stolky','Skříň: polovina s posuvnými čely, polovina otevřená','Velký obraz za postelí','Nástěnná klimatizace a venkovní roleta']},
    ...
    wc: {name:'WC', title:'Samostatné WC', text:'Součást nového bytového jádra. Stoupačky jsou za WC.', materials:[['Šedý obklad','#929594'],['Bílá sanita','#ededeb']], items:['WC v samostatné místnosti','Přístup k instalační šachtě','Navržené osvětlení a přívody']},
