(() => {
  const rooms = {
    all: {name:'Celý byt', title:'Všechno na jednom místě', text:'Vyber místnost vlevo. Zobrazí se samostatně, spolu s přehledem vybavení.', materials:[['Dub','#bf9567'],['Sklo','#a5c0c4'],['Kámen','#8f9494']], items:['Podhled 12 cm v celém bytě · světlá výška 2,48 m','Obývák s kuchyní a promítáním','Pracovna s hudebním koutem','Dětský pokoj a ložnice','Nové jádro, šatna a úložné prostory']},
